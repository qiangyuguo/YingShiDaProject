<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="TalentConcept.aspx.cs" Inherits="YingShiDa.HumanResources.TalentConcept" %>
...
<head>
    ...
    <script type="text/javascript">
        ...
        function Edit(ID) {
            $.PE_FrameTab.AddNew('/HumanResources/TalentConceptAdd.aspx?action=notify&ID=' + ID, "修改");
        }

        function Add() {
            $.PE_FrameTab.AddNew('/HumanResources/TalentConceptAdd.aspx', '添加');
        }
    </script>
    <style type="text/css">
        .fancybox-margin {
                    ...
                    <div class="row wrapper border-bottom white-bg page-heading">
                        <div class="col-lg-12">
                            <ol class="breadcrumb">
                                ...
                                <li><strong>人才理念</strong></li>
                            </ol>
                        </div>
                    </div>
                    <div class="statistics trade">
                        <ul class="nav nav-tabs">
                            <li class="active"><a href="#jilu1" data-toggle="tab">人才理念</a></li>
                        </ul>
