<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ServoDriver.aspx.cs" Inherits="YingShiDa.ProductCenter.ServoDriver" %>
                    ...
                    <div class="statistics trade">
                        <div class="tabbable">
                            ...
                            <div class="tab-content">
                                                    ...
                                                    <asp:Repeater ID="rptChannel" runat="server" OnItemCommand="rptSpec_ItemCommand">
                                                        ...
                                                        <ItemTemplate>
                                                            <tr>
                                                                ...
                                                                <td>
                                                                    <asp:Literal ID="Literal1" runat="server" Text='<%#Eval("ProductTitle")%>'></asp:Literal>&nbsp;
                                                                </td>
                                                                <td>
                                                                ...
                                                                <td>
                                                                    <asp:LinkButton Text="删除" ID="btnDelete" runat="server" class="color-light-blue" OnClientClick="javascript:return confirm('会删除与此产品关联的产品型号和产品详情，确定删除?');" CommandName="Delete" CommandArgument='<%#Eval("ID")%>' />
                                ...
                                <div class="stati-content tab-pane" id="jilu2">
                                    <input type="hidden" id="hfProductType" />
                                    <iframe id="sonframe"" height="77%" width="100%"></iframe>
                                </div>
                                <script type="text/javascript">
                                    $(document).ready(function () {
                                        var ProductType = getUrlParam("ProductType");
