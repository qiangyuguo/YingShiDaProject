<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ServoDriverDetail.aspx.cs" Inherits="YingShiDa.ProductCenter.ServoDriverDetail" %>
...
<head>
    ...
    <script type="text/javascript">
        ...
        function Add() {
            ...
            $.PE_FrameTab.AddNew('/ProductCenter/ServoDriverDetailAdd.aspx?ProductType=' + ProductType, '添加');
        }
    </script>
    <style type="text/css">
        .fancybox-margin {
...
<body class="pace-done">
    <form id="form" runat="server">
        <div id="wrapper">
            <div id="page-wrapper" class="gray-bg dashbard-1 iframpagewapper" style="padding-left: 0px; padding-right: 0px">
                <div id="body-content" class="clearfix" style="background-color: white">
                    <div class="statistics trade iframstatistics">
                        <div class="stati-content" id="jilu1">
                                            ...
                                            <asp:Repeater ID="rptChannel" runat="server" OnItemCommand="rptSpec_ItemCommand">
                                                ...
                                                <ItemTemplate>
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <asp:Literal ID="Literal2" runat="server" Text='<%#Eval("ProductModel")%>'></asp:Literal>&nbsp;
                                                        </td>
                                                        <td>
                                                            <asp:Literal ID="Literal3" runat="server" Text='<%#Eval("Series")%>'></asp:Literal>&nbsp;
                                                        </td>
                                                        <td>
