<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="MemberToGroupListAdd.aspx.cs" ValidateRequest="false" Inherits="YingShiDa.TechnicalSupport.MemberToGroupListAdd" %>
...
<head>
    ...
    <script type="text/javascript">
        function firstForm() {
            $.PE_FrameTab.AddNew('/TechnicalSupport/MemberToGroupList.aspx', '常见问题答疑列表');
        }
    </script>
    <style type="text/css">
        .cssHide {
                        ...
                        <div class="panel white-bg">
                            ...
                            <div class="panel-body">
                                <form runat="server" id="form1" class="form-horizontal" method="post" enctype="multipart/form-data" novalidate="novalidate">
                                    ...
                                    <div class="form-group">
                                        <label class="control-label col-md-1 ">正文问题</label>
                                        <span class="red-xing">*</span>
                                        <div class="col-md-10">
                                            <asp:TextBox ID="txtContentQuestion" MaxLength="50" TextMode="MultiLine" onkeyup="value=value.replace(/[&*%$#]/g,'')" onkeypress="return keyPress()" runat="server" CssClass="form-control" />
                                        </div>
                                    </div>

                                    <div class="form-group">
                                        <label class="control-label col-md-1 ">正文答案</label>
                                        <span class="red-xing">*</span>
                                        <div class="col-md-10">
                                            <asp:TextBox ID="txtContentAnswer" MaxLength="50" TextMode="MultiLine" onkeyup="value=value.replace(/[&*%$#]/g,'')" onkeypress="return keyPress()" runat="server" CssClass="form-control" />
                                        </div>
                                    </div>
