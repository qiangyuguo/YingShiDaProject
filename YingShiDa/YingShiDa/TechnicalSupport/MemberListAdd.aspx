<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="MemberListAdd.aspx.cs" ValidateRequest="false" Inherits="YingShiDa.TechnicalSupport.MemberListAdd" %>
...
<head>
    ...
    <script type="text/javascript">
        function firstForm() {
            $.PE_FrameTab.AddNew('/TechnicalSupport/MemberList.aspx', '服务理念列表');
        }
    </script>
    <style type="text/css">
        .cssHide {
