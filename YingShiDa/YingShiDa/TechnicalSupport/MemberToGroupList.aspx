<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="MemberToGroupList.aspx.cs" Inherits="YingShiDa.TechnicalSupport.MemberToGroupList" %>
...
<head>
    ...
    <script type="text/javascript">
        ...
        function Edit(ID) {
            $.PE_FrameTab.AddNew('/TechnicalSupport/MemberToGroupListAdd.aspx?action=notify&ID=' + ID, "修改");
        }

        function Add() {
            $.PE_FrameTab.AddNew('/TechnicalSupport/MemberToGroupListAdd.aspx', '添加');
        }
    </script>
    <style type="text/css">
        .fancybox-margin {
                    ...
                    <div class="row wrapper border-bottom white-bg page-heading">
                        <div class="col-lg-12">
                            <ol class="breadcrumb">
                                ...
                                <li><strong>常见问题答疑</strong></li>
                            </ol>
                        </div>
                    </div>
                    <div class="statistics trade">
                        <ul class="nav nav-tabs">
                            <li class="active"><a href="#jilu1" data-toggle="tab">常见问题答疑</a></li>
                        </ul>
                                            ...
                                            <asp:Repeater ID="rptChannel" runat="server" OnItemCommand="rptSpec_ItemCommand">
                                                <HeaderTemplate>
                                                    <thead>
                                                        <tr>
                                                            ...
                                                            <th style="min-width: 80px; width: auto">正文问题</th>
                                                            <th style="min-width: 80px; width: auto">正文答案</th>
                                                ...
                                                <ItemTemplate>
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <asp:Literal ID="Literal2" runat="server" Text='<%#Eval("ContentQuestion")%>'></asp:Literal>&nbsp;
                                                        </td>
                                                        <td>
                                                            <asp:Literal ID="Literal3" runat="server" Text='<%#Eval("ContentAnswer")%>'></asp:Literal>&nbsp;
                                                        </td>
                                                        <td>
