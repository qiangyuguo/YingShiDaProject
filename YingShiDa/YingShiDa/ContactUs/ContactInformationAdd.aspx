<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ContactInformationAdd.aspx.cs" ValidateRequest="false" Inherits="YingShiDa.ContactUs.ContactInformationAdd" %>
...
<head>
    ...
    <script type="text/javascript">
        function firstForm() {
            $.PE_FrameTab.AddNew('/ContactUs/ContactInformation.aspx', '联系方式列表');
        }
    </script>
    <style type="text/css">
        .cssHide {
                        ...
                        <div class="panel white-bg">
                            ...
                            <div class="panel-body">
                                <form runat="server" id="form1" class="form-horizontal" method="post" enctype="multipart/form-data" novalidate="novalidate">
                                    ...
                                    <div class="form-group">
                                        <label class="control-label col-md-1 ">公司</label>
                                        <span class="red-xing">*</span>
                                        <div class="col-md-10">
                                            <asp:TextBox ID="txtCompany" MaxLength="100" onkeyup="value=value.replace(/[&*%$#]/g,'')" onkeypress="return keyPress()" runat="server" CssClass="form-control" />
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <span class="red-xing">*</span>
                                        <div class="col-md-10">
                                            <asp:TextBox ID="txtAddress" MaxLength="150" onkeyup="value=value.replace(/[&*%$#]/g,'')" onkeypress="return keyPress()" runat="server" CssClass="form-control" />
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <span class="red-xing">*</span>
                                        <div class="col-md-10">
                                            <asp:TextBox ID="txtPhone" MaxLength="30" onkeyup="value=value.replace(/[&*%$#]/g,'')" onkeypress="return keyPress()" runat="server" CssClass="form-control" />
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <span class="red-xing">*</span>
                                        <div class="col-md-10">
                                            <asp:TextBox ID="txtFax" MaxLength="30" onkeyup="value=value.replace(/[&*%$#]/g,'')" onkeypress="return keyPress()" runat="server" CssClass="form-control" />
                                        </div>
                                    </div>

                                    <div class="form-group">
                                        <label class="control-label col-md-1 ">邮编</label>
                                        <span class="red-xing">*</span>
                                        <div class="col-md-10">
                                            <asp:TextBox ID="txtPostcode" MaxLength="30" onkeyup="value=value.replace(/[&*%$#]/g,'')" onkeypress="return keyPress()" runat="server" CssClass="form-control" />
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <span class="red-xing">*</span>
                                        <div class="col-md-10">
                                            <asp:TextBox ID="txtmailbox" MaxLength="30" onkeyup="value=value.replace(/[&*%$#]/g,'')" onkeypress="return keyPress()" runat="server" CssClass="form-control" />
                                        </div>
                                    </div>
