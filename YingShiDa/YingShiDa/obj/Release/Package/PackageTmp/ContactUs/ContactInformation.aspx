<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ContactInformation.aspx.cs" Inherits="YingShiDa.ContactUs.ContactInformation" %>
...
<head>
    ...
    <script type="text/javascript">
        ...
        function Edit(ID) {
            $.PE_FrameTab.AddNew('/ContactUs/ContactInformationAdd.aspx?action=notify&ID=' + ID, "修改");
        }

        function Add() {
            $.PE_FrameTab.AddNew('/ContactUs/ContactInformationAdd.aspx', '添加');
        }
    </script>
    <style type="text/css">
        .fancybox-margin {
                ...
                <div id="body-content" class="clearfix">
                    ...
                    <div class="statistics trade">
                        <ul class="nav nav-tabs">
                            <li class="active"><a href="#jilu1" data-toggle="tab">联系方式</a></li>
                        </ul>
                                            ...
                                            <asp:Repeater ID="rptChannel" runat="server" OnItemCommand="rptSpec_ItemCommand">
                                                <HeaderTemplate>
                                                    <thead>
                                                        <tr>
                                                            ...
                                                            <th style="min-width: 80px; width: auto">公司</th>
                                                            <th style="min-width: 80px; width: auto">地址</th>
                                                            <th style="min-width: 80px; width: auto">电话</th>
                                                            <th style="min-width: 80px; width: auto">邮箱</th>
                                                ...
                                                <ItemTemplate>
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <asp:Literal ID="Literal3" runat="server" Text='<%#Eval("Company")%>'></asp:Literal>&nbsp;
                                                        </td>
                                                        <td>
                                                            <asp:Literal ID="Literal4" runat="server" Text='<%#Eval("Address")%>'></asp:Literal>&nbsp;
                                                        </td>
                                                        <td>
                                                            <asp:Literal ID="Literal5" runat="server" Text='<%#Eval("Phone")%>'></asp:Literal>&nbsp;
                                                        </td>
                                                        <td>
                                                            <asp:Literal ID="Literal8" runat="server" Text='<%#Eval("mailbox")%>'></asp:Literal>&nbsp;
                                                        </td>
                                                        <td>
