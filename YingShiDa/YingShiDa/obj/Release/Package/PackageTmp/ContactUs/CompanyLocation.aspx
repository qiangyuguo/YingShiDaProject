<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="CompanyLocation.aspx.cs" Inherits="YingShiDa.ContactUs.CompanyLocation" %>
...
<head>
    ...
    <script type="text/javascript">
        ...
        function Edit(ID) {
            $.PE_FrameTab.AddNew('/ContactUs/CompanyLocationAdd.aspx?action=notify&ID=' + ID, "修改");
        }

        function Add() {
            $.PE_FrameTab.AddNew('/ContactUs/CompanyLocationAdd.aspx', '添加');
        }
    </script>
    <style type="text/css">
        .fancybox-margin {
                    ...
                    <div class="row wrapper border-bottom white-bg page-heading">
                        <div class="col-lg-12">
                            <ol class="breadcrumb">
                                ...
                                <li><strong>公司位置</strong></li>
                            </ol>
                        </div>
                    </div>
                    <div class="statistics trade">
                        <ul class="nav nav-tabs">
                            <li class="active"><a href="#jilu1" data-toggle="tab">公司位置</a></li>
                        </ul>
