<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="TeamCarousel.aspx.cs" Inherits="YingShiDa.Carousel.TeamCarousel" %>
...
<head>
    ...
    <script type="text/javascript">
        ...
        function Edit(ID) {
            $.PE_FrameTab.AddNew('/Carousel/TeamCarouselAdd.aspx?action=notify&ID=' + ID, "修改");
        }

        function Add() {
            $.PE_FrameTab.AddNew('/Carousel/TeamCarouselAdd.aspx', '添加');
        }
    </script>
    <style type="text/css">
        .fancybox-margin {
            ...
            <div id="page-wrapper" class="gray-bg dashbard-1">
                <div id="body-content" class="clearfix">
                    <div class="row wrapper border-bottom white-bg page-heading">
                        <div class="col-lg-12">
                            <ol class="breadcrumb">
                                <li><strong>轮播图片</strong></li>
                                <li><strong>团队轮播图片</strong></li>
                            </ol>
                        </div>
                    </div>
                    <div class="statistics trade">
                        <ul class="nav nav-tabs">
                            <li class="active"><a href="#jilu1" data-toggle="tab">团队轮播图片</a></li>
                        </ul>
                                            ...
                                            <asp:Repeater ID="rptChannel" runat="server" OnItemCommand="rptSpec_ItemCommand">
                                                <HeaderTemplate>
                                                    <thead>
                                                        <tr>
                                                            ...
                                                            <th style="min-width: 80px; width: auto">内容一</th>
                                                            <th style="min-width: 80px; width: auto">内容二</th>
                                                            <th style="min-width: 80px; width: auto">内容三</th>
                                                            <th style="min-width: 80px; width: auto">创建人</th>
                                                ...
                                                <ItemTemplate>
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <asp:Literal ID="Literal3" runat="server" Text='<%#Eval("Content1")%>'></asp:Literal>&nbsp;
                                                        </td>
                                                        <td>
                                                            <asp:Literal ID="Literal4" runat="server" Text='<%#Eval("Content2")%>'></asp:Literal>&nbsp;
                                                        </td>
                                                        <td>
                                                            <asp:Literal ID="Literal5" runat="server" Text='<%#Eval("Content3")%>'></asp:Literal>&nbsp;
                                                        </td>
                                                        <td>
                                                            <asp:Literal ID="Literal2" runat="server" Text='<%#Eval("CreatePeople")%>'></asp:Literal>&nbsp;
                                                        </td>
                                                        <td>
