...
function AddUser() {
    ...
    document.getElementById("AddUseraccount").disabled = "";
    document.getElementById("AddPassWord").disabled = "";
        ...
        buttons: {
            '保存': function () {
                if ($("#AddUseraccount").val() == '') {
                    ...
                    alert("初始密码不能为空!");
                    return false;
                } else if ($("#AddPassWord").val().length < 6 || $("#AddPassWord").val().length > 16) {
                    alert("密码长度6-16位!");
                    return false;
                }
                else {
                    ...
                    var BusinessAreaID = encodeURIComponent($("#BusinessAreaID").val());
                    $.ajax({
                        url: '/Action/User.ashx',
                        data: 'Action=Add&objPassWord=' + PassWord + '&objUseraccount=' + Useraccount + '&objBusinessAreaID=' + BusinessAreaID + '&objUsername=' + UserName,
                        type: 'get',
                        asyn: true,
                        dataType: 'html',
                        cache: false,
...
function reset() {
    var varAddPassWord = document.getElementById("AddPassWord");
    var varAddUseraccount = document.getElementById("AddUseraccount");
    var varAddUsername = document.getElementById("AddUsername");
    varAddPassWord.disabled = "";
    varAddUseraccount.disabled = "";
    varAddUsername.disabled = "";
    varAddUseraccount.innerText = "";
    varAddUsername.innerText = "";
    varAddPassWord.innerText = "";
}
//修改用户
function EditUser(UserAccount, UserName, Passwd) {
    ...
    // document.getElementById("AddPassWord").value = Passwd;
        ...
        buttons: {
            '保存': function () {
                if ($("#AddUseraccount").val() == '') {
                    ...
                    $.ajax({
                        url: '/Action/User.ashx',
                        data: 'Action=Edit&objUseraccount=' + Useraccount + '&objBusinessAreaID=' + BusinessAreaID + '&objUsername=' + UserName + '&objPassWord=' + PassWord,
                        type: 'get',
                        asyn: true,
                        dataType: 'html',
                        cache: false,
