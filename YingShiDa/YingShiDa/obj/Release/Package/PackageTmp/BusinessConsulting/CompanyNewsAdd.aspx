<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="CompanyNewsAdd.aspx.cs" ValidateRequest="false" Inherits="YingShiDa.BusinessConsulting.CompanyNewsAdd" %>
...
<head>
    ...
    <script type="text/javascript">
        function firstForm() {
            $.PE_FrameTab.AddNew('/BusinessConsulting/CompanyNews.aspx', '公司新闻列表');
        }
        function checkSave() {
            var createCompany = $.trim($("#txtCreateCompany").val());
            if (createCompany == "") {
                layer.alert("创建公司不能为空", {
                    icon: 5,
                    offset: '10%'
                });
                return false;
                        ...
                        <div class="panel white-bg">
                            ...
                            <div class="panel-body">
                                <form runat="server" id="form1" class="form-horizontal" method="post" enctype="multipart/form-data" novalidate="novalidate">
                                    ...
                                    <div class="form-group">
                                        <label class="control-label col-md-1 ">创建公司</label>
                                        <span class="red-xing" style="margin-left: 6.7px"></span>
                                        <div class="col-md-10">
                                            <asp:TextBox ID="txtCreateCompany" MaxLength="30" onkeyup="value=value.replace(/[&*%$#]/g,'')" onkeypress="return keyPress()" runat="server" CssClass="form-control" />
                                        </div>
                                    </div>
