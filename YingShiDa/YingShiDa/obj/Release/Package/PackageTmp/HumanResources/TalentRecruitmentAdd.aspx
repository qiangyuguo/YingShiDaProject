<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="TalentRecruitmentAdd.aspx.cs" ValidateRequest="false" Inherits="YingShiDa.HumanResources.TalentRecruitmentAdd" %>
...
<head>
    ...
    <script type="text/javascript">
        function firstForm() {
            $.PE_FrameTab.AddNew('/HumanResources/TalentRecruitment.aspx', '人才招聘列表');
        }
        $(document).ready(function () {
            //首页图片上传
            $('#HomePageUploadImg').click(function () {
                $("#hfResponsibilities").val(um1.getContent());
                $("#hfJobRequirements").val(um2.getContent());
            });
        })
    </script>
    <style type="text/css">
                        ...
                        <div class="panel white-bg">
                            ...
                            <div class="panel-body">
                                <form runat="server" id="form1" class="form-horizontal" method="post" enctype="multipart/form-data" novalidate="novalidate">
                                    ...
                                    <div class="form-group">
                                        <label class="control-label col-md-1 ">招聘岗位</label>
                                        <span class="red-xing">*</span>
                                        <div class="col-md-10">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <span class="red-xing">*</span>
                                        <div class="col-md-10">
                                            <asp:TextBox ID="txtDepartment" MaxLength="30" onkeyup="value=value.replace(/[&*%$#]/g,'')" onkeypress="return keyPress()" runat="server" CssClass="form-control" />
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <span class="red-xing">*</span>
                                        <div class="col-md-10">
                                            <asp:TextBox ID="txtNumber" MaxLength="10" onkeyup="value=value.replace(/[&*%$#]/g,'')" onkeypress="return keyPress()" runat="server" CssClass="form-control" />
                                        </div>
                                    </div>

                                    <div class="form-group">
                                        <label class="control-label col-md-1 ">岗位职责</label>
                                        <span class="red-xing">*</span>
                                        <div class="col-md-10">
                                            <script type="text/plain" id="txtResponsibilities" placeholder="请输入100-500个字符以内" style="width: 100%; height: 180px;"></script>
                                        </div>
                                    </div>

                                    <div class="form-group">
                                        <label class="control-label col-md-1 ">岗位要求</label>
                                        <span class="red-xing">*</span>
                                        <div class="col-md-10">
                                            <script type="text/plain" id="txtJobRequirements" placeholder="请输入100-500个字符以内" style="width: 100%; height: 180px;"></script>
                                        </div>
                                    </div>

                                    <div class="form-group">
                                        <label class="control-label col-md-1 ">薪资待遇</label>
                                        <span class="red-xing">*</span>
                                        <div class="col-md-10">
                                            <asp:TextBox ID="txtSalary" MaxLength="30" onkeyup="value=value.replace(/[&*%$#]/g,'')" onkeypress="return keyPress()" runat="server" CssClass="form-control" />
                                        </div>
                                    </div>
                                    ...
                                    <asp:HiddenField runat="server" ID="hfResponsibilities" />
                                    <asp:HiddenField runat="server" ID="hfJobRequirements" />
                                </form>
                                <script type="text/javascript">
                                    //实例化编辑器
                                    var um1= UM.getEditor('txtResponsibilities');
                                    var um2= UM.getEditor('txtJobRequirements');
                                    window.UMEDITOR_HOME_URL = "/umeditor1_2_2-utf8-net/";
                                    var strData = '<%=Responsibilities %>';
                                    var strData1 = '<%=JobRequirements %>';
