<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="TalentRecruitment.aspx.cs" Inherits="YingShiDa.HumanResources.TalentRecruitment" %>
...
<head>
    ...
    <script type="text/javascript">
        ...
        function Edit(ID) {
            $.PE_FrameTab.AddNew('/HumanResources/TalentRecruitmentAdd.aspx?action=notify&ID=' + ID, "修改");
        }

        function Add() {
            $.PE_FrameTab.AddNew('/HumanResources/TalentRecruitmentAdd.aspx', '添加');
        }
    </script>
    <style type="text/css">
        .fancybox-margin {
                ...
                <div id="body-content" class="clearfix">
                    ...
                    <div class="statistics trade">
                        <ul class="nav nav-tabs">
                            <li class="active"><a href="#jilu1" data-toggle="tab">人才招聘</a></li>
                        </ul>
                        <div class="stati-content tab-pane active" id="jilu1">
                            <div class="stati-tool clearfix">
                                <div class="stati-time">
                                    <asp:TextBox ID="txtTitle" type="text" placeholder="招聘岗位" runat="server" class="stati-maker stati-tool-item br4" value=""></asp:TextBox>
                                </div>
                                <div class="stati-time">
                                            ...
                                            <asp:Repeater ID="rptChannel" runat="server" OnItemCommand="rptSpec_ItemCommand">
                                                <HeaderTemplate>
                                                    <thead>
                                                        <tr>
                                                            ...
                                                            <th style="min-width: 80px; width: auto">招聘岗位</th>
                                                            <th style="min-width: 80px; width: auto">部门</th>
                                                            <th style="min-width: 80px; width: auto">人数</th>
                                                            <th style="min-width: 80px; width: auto">岗位职责</th>
                                                            <th style="min-width: 80px; width: auto">岗位要求</th>
                                                            <th style="min-width: 80px; width: auto">薪资要求</th>
                                                ...
                                                <ItemTemplate>
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <asp:Literal ID="Literal2" runat="server" Text='<%#Eval("Department")%>'></asp:Literal>&nbsp;
                                                        </td>
                                                        <td>
                                                            <asp:Literal ID="Literal3" runat="server" Text='<%#Eval("Number")%>'></asp:Literal>&nbsp;
                                                        </td>
                                                        <td>
                                                            <asp:Literal ID="Literal4" runat="server" Text='<%#Eval("Responsibilities")%>'></asp:Literal>&nbsp;
                                                        </td>
                                                        <td>
                                                            <asp:Literal ID="Literal5" runat="server" Text='<%#Eval("JobRequirements")%>'></asp:Literal>&nbsp;
                                                        </td>
                                                        <td>
                                                            <asp:Literal ID="Literal8" runat="server" Text='<%#Eval("Salary")%>'></asp:Literal>&nbsp;
                                                        </td>
                                                        <td>
