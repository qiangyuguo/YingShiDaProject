<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ServoDriverAdd.aspx.cs" ValidateRequest="false" Inherits="YingShiDa.ProductCenter.ServoDriverAdd" %>
...
<head>
    ...
    <title><%=new Method.ProductType().GetName(Request["ProductType"].ToString()) %>新增</title>
    ...
    <link href="../Content/Css/Product/ProductAdd.css" rel="stylesheet" />
    ...
    <script type="text/javascript">
        ...
        function firstForm() {
            ...
            $.PE_FrameTab.AddNew('/ProductCenter/ServoDriver.aspx?ProductType=' + ProductType, '<%=new Method.ProductType().GetName(Request["ProductType"].ToString()) %>列表');
        }
    </script>
    <style type="text/css">
        .cssHide {
                ...
                <div class="row wrapper border-bottom white-bg page-heading">
                    <div class="col-lg-12">
                        <ol class="breadcrumb">
                            ...
                            <li><strong>编辑<%=new Method.ProductType().GetName(Request["ProductType"].ToString()) %></strong></li>
                        </ol>
                    </div>
                </div>
                            ...
                            <div class="panel-body">
                                <form runat="server" id="form1" class="form-horizontal" method="post" enctype="multipart/form-data" novalidate="novalidate">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <span class="red-xing">*</span>
                                        <div class="col-md-10">
                                            <input type="text" style="float: left;text-indent: 1em;" placeholder="请输入型号" id="txtProductModel">
                                            <button class="stati-check br4 stati-tool-item" onclick="return ProductAdd()" style="width: 90px;">
                                                <i class="glyphicon glyphicon-plus"></i>
                                                新建
                                            </button>
                                            <table border="1" cellpadding="0" cellspacing="0" id="AddProductModel">
                                                <tr>
                                                    <th>型号</th>
                                                    <th>操作</th>
                                                </tr>
                                    ...
                                    <asp:HiddenField runat="server" ID="hfArrList" />
                                    <asp:HiddenField runat="server" ID="hfHtml" />
                                    <asp:HiddenField runat="server" ID="hfEditHtml" />
                                </form>
                            </div>
                        </div>
                    </div>
