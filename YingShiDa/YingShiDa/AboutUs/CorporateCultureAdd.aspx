<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="CorporateCultureAdd.aspx.cs" ValidateRequest="false" Inherits="YingShiDa.AboutUs.CorporateCultureAdd" %>
...
<head>
    ...
    <script type="text/javascript">
        function firstForm() {
            $.PE_FrameTab.AddNew('/AboutUs/CorporateCulture.aspx', '企业文化列表');
        }
    </script>
    <style type="text/css">
        .cssHide {
