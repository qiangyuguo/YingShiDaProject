<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="DevelopmentHistory.aspx.cs" Inherits="YingShiDa.AboutUs.DevelopmentHistory" %>
...
<head>
    ...
    <script type="text/javascript">
        ...
        function Edit(ID) {
            $.PE_FrameTab.AddNew('/AboutUs/DevelopmentHistoryAdd.aspx?action=notify&ID=' + ID, "修改");
        }

        function Add() {
            $.PE_FrameTab.AddNew('/AboutUs/DevelopmentHistoryAdd.aspx', '添加');
        }
    </script>
    <style type="text/css">
        .fancybox-margin {
                ...
                <div id="body-content" class="clearfix">
                    ...
                    <div class="statistics trade">
                        <ul class="nav nav-tabs">
                            <li class="active"><a href="#jilu1" data-toggle="tab">发展历程</a></li>
                        </ul>
