<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="TeamCarouselAdd.aspx.cs" ValidateRequest="false" Inherits="YingShiDa.Carousel.TeamCarouselAdd" %>
...
<head>
    ...
    <script type="text/javascript">
        function checkSave() {
            ...
            var txtContent1 = $.trim($("#txtContent1").val());
            var txtContent2 = $.trim($("#txtContent2").val());
            var txtContent3 = $.trim($("#txtContent3").val());
            if (text == "") {
                layer.alert("标题不能为空", {
                    icon: 5,
                    offset: '10%'
        ...
        function firstForm() {
            $.PE_FrameTab.AddNew('/Carousel/TeamCarousel.aspx', '团队轮播图片');
        }
