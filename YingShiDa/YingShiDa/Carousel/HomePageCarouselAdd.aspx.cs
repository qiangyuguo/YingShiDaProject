...
{
    public partial class HomePageCarouselAdd : PageBase
    {
        public static string PhotoPath = "HomePage\\";
        private string photoTempPath = "HomePage\\Temp\\";
        ...
        public void BindData()
        {
            ...
            if (view_action == "notify")
            {
                if (cp != null)
                {
                    ...
                    var photolist = cp.BannerPicname;
