<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="HomePageCarousel.aspx.cs" Inherits="YingShiDa.Carousel.HomePageCarousel" %>
...
<head>
    ...
    <script type="text/javascript">
        ...
        function Edit(ID) {
            $.PE_FrameTab.AddNew('/Carousel/HomePageCarouselAdd.aspx?action=notify&ID=' + ID, "修改");
        }

        function Add() {
            $.PE_FrameTab.AddNew('/Carousel/HomePageCarouselAdd.aspx', '添加');
        }
    </script>
    <style type="text/css">
        .fancybox-margin {
                ...
                <div id="body-content" class="clearfix">
                    ...
                    <div class="statistics trade">
                        <ul class="nav nav-tabs">
                            <li class="active"><a href="#jilu1" data-toggle="tab">首页轮播图片</a></li>
                        </ul>
