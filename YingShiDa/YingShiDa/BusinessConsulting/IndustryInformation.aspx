<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="IndustryInformation.aspx.cs" Inherits="YingShiDa.BusinessConsulting.IndustryInformation" %>
...
<head>
    ...
    <script type="text/javascript">
        ...
        function Edit(ID) {
            $.PE_FrameTab.AddNew('/BusinessConsulting/IndustryInformationAdd.aspx?action=notify&ID=' + ID, "修改");
        }

        function Add() {
            $.PE_FrameTab.AddNew('/BusinessConsulting/IndustryInformationAdd.aspx', '添加');
        }
    </script>
    <style type="text/css">
        .fancybox-margin {
            ...
            <div id="page-wrapper" class="gray-bg dashbard-1">
                <div id="body-content" class="clearfix">
                    <div class="row wrapper border-bottom white-bg page-heading">
                        <div class="col-lg-12">
                            <ol class="breadcrumb">
                                <li><strong>公司咨询</strong></li>
                                <li><strong>行业资讯</strong></li>
                            </ol>
                        </div>
                    </div>
                    <div class="statistics trade">
                        <ul class="nav nav-tabs">
                            <li class="active"><a href="#jilu1" data-toggle="tab">行业资讯</a></li>
                        </ul>
