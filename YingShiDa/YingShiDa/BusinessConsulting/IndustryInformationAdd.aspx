<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="IndustryInformationAdd.aspx.cs" ValidateRequest="false" Inherits="YingShiDa.BusinessConsulting.IndustryInformationAdd" %>
...
<head>
    ...
    <script type="text/javascript">
        function firstForm() {
            $.PE_FrameTab.AddNew('/BusinessConsulting/IndustryInformation.aspx', '行业资讯列表');
        }
    </script>
    <style type="text/css">
        .cssHide {
